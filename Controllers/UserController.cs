...
//          public IActionResult Save(int idu,string userid, string nombreuser,string passuser,int idr)
//         {
...
//                 };
//              r.Usuarioss.Add(nuevouser);
           

//                 r.UsuarioRoles.Add(usrol);
//              r.SaveChanges();
